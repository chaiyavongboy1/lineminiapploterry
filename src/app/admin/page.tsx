...
export default function AdminDashboard() {
    ...
    const [stats, setStats] = useState<Stats>({ totalOrders: 0, pendingReview: 0, approved: 0, totalRevenue: 0 });
    ...
    useEffect(() => {
        ...
        async function fetchStats() {
            try {
                const res = await fetch(`/api/admin/orders?adminLineUserId=${userId}`);
                ...
                if (result.success) {
                    ...
                    setStats({
                        ...
                        totalRevenue: orders.filter(o => o.status === 'completed').reduce((sum, o) => sum + Number(o.total_amount), 0),
                    });
