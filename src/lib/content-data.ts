...
export const DEFAULT_CONTENT: ContentSection[] = [
    {
        ...
        subtitle: 'About Us',
        icon: '🏢',
        content: `America Lottery Thailand เป็นตัวแทนจำหน่ายลอตเตอรี่อเมริกาอย่างเป็นทางการ ให้บริการรับฝากซื้อ Powerball และ Mega Millions ผ่านแอปพลิเคชัน LINE Mini App อย่างสะดวกและปลอดภัย
...
1️⃣ เลือก Lottery — เลือก Powerball หรือ Mega Millions
...
📋 ตั๋ว Lottery จริง — ซื้อจากร้านค้าอย่างเป็นทางการในสหรัฐฯ
✅ ตรวจผลอัตโนมัติ — จากแหล่งข้อมูลทางการรัฐบาล`,
    ...
    },
    {
        ...
        subtitle: 'FAQ',
        icon: '❓',
        content: `ถาม: ฝากซื้อ Lottery อเมริกาถูกกฎหมายไหม?
ตอบ: การฝากซื้อ Lottery อเมริกาผ่านตัวแทนเป็นรูปแบบที่ถูกกฎหมายในสหรัฐอเมริกา
...
2. การฝากซื้อ Lottery ทุกรายการเป็นที่สิ้นสุด ไม่สามารถยกเลิกหลังชำระเงินแล้ว
3. ผลรางวัลอ้างอิงจากการประกาศอย่างเป็นทางการของรัฐบาลสหรัฐฯ
4. เงินรางวัลที่ยอดรวมตั้งแต่ $600 ขึ้นไปต่อออร์เดอร์จะถูกหักภาษี ณ ที่จ่ายตามกฎหมายที่เกี่ยวข้อง
5. บริษัทขอสงวนสิทธิ์ในการเปลี่ยนแปลงเงื่อนไขโดยไม่ต้องแจ้งล่วงหน้า

© 2026 America Lottery Thailand. สงวนลิขสิทธิ์.`,
        is_visible: true,
        sort_order: 9,
    },
];
